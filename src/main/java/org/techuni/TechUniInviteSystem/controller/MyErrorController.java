...
public class MyErrorController implements ErrorController {
    ...
    public ModelAndView myErrorHtml(HttpServletRequest request) {
        ...
        // 出力したい情報をセットする
        return new ErrorResponse(status).createView();
    }
    ...
    private record ErrorInfo(String exception, String exceptionType, String message, String request_uri, String servlet, String status_code) {

        public ErrorInfo(HttpServletRequest req) {
            this(String.valueOf(req.getAttribute(RequestDispatcher.ERROR_EXCEPTION)),
